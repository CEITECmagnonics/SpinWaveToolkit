...
CoFeBchar = SWT.DispersionCharacteristic(kxi = kxi, theta = np.pi/2, phi = np.pi/2, d = 100e-9, boundaryCond = 1, Bext = 1.5, material = MagnetronCoFeB)
